...
technologies: ["Java", "Spring Boot", "Groovy", "Spock", "Kotlin", "AWS", "S3", "SQS", "DynamoDB", "RDS", "Fargate", "Docker", "GitHub Actions", "OpenTelemetry", "X-Ray"]
weight: 116
---
...
- Operated in an event-sourced microservice architecture on AWS with CloudWatch and Kibana monitoring in Agile Scrum ceremonies.
